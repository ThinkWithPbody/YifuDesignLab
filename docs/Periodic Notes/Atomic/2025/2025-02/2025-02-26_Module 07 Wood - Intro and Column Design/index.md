...
- Typical Construction
	- ![468x260](/docs/assets/img/image.webp)
	- ![308x466](/docs/assets/img/image-1.webp)
	- ![293x399](/docs/assets/img/image-1-1.webp)
- Lumber Visual Grades
	...
	- No. 3
	- Stud
	- ![image-2](/docs/assets/img/image-2.webp)
- Strength and Modulus of Elasticity
	- Look up table A-D [SAWN LUMBER, p.5](/docs/assets/img/SAWN%20LUMBER.pdf.md#page=5)
		- ![640x384](/docs/assets/img/image-8.webp)
		- ![640x306](/docs/assets/img/image-9.webp)
		- ![640x384](/docs/assets/img/image-10.webp)
		- ![640x379](/docs/assets/img/image-11.webp)
	- Governed by Applications, Species, Grades
- $K_D$: Load Duration Factor
	- Short Term = 1.15
	- Standard Term = 1.00
	- Long Term = 0.65
	- ![640x407](/docs/assets/img/image-2-1.webp)
- $K_H$: System Factor
	- 1.0 if not part of a system - Post / Beam
	- More if part of a system sharing some loads - Joist / Stud
	- ![640x275](/docs/assets/img/image-7.webp)
	- Case 1 | Case 2
		- Most floors and walls are Case 2
		- ![640x375](/docs/assets/img/image-3.webp)
- $K_S$: Service Condition Factor
	- Outside use or a pool would be wet
	- Always 1.0 if dry
	- ![640x278](/docs/assets/img/image-6.webp)
- $K_T$: Treatment Factor
	...
	- ![640x403](/docs/assets/img/image-5.webp)
- $K_Z$: Size Factor
	...
	- ![640x428](/docs/assets/img/image-12.webp)
- Wood and Steel
	- $P_r=\phi \sigma A + Factors/Buckling$
	- $C_r=\phi \sigma A + Factors/Buckling$
	- Essentially the same
	- ![352x274](/docs/assets/img/image-4.webp)
...
- $P_{r}(N)=\phi_c \times F_c \times A \times K_{zc} \times K_c$: **Compression Resistance Design**
	...
	- $F_c(MPa)=f_c(K_D K_H K_{SC} K_T)$
		- $f_c$: Specified strength (stress) in compression parallel to grain, looked up from Table A-D [SAWN LUMBER, p.5](/docs/assets/img/SAWN%20LUMBER.pdf.md#page=5)
