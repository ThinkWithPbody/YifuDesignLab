...
1. Follow [File Preparation](index.md#file-preparation) and export files.
2. Choose your [Filament](index.md#filament).
3. Choose from one of the [Quality Presets](index.md#quality-presets).
4. Adjust [Slicing Options](index.md#slicing-options) as needed.
